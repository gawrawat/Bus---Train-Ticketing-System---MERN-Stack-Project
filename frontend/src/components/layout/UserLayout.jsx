...
import { Bus, Train, MapPin, Calendar, ArrowRight, Mail, Phone, Map, Clock, Ticket, Users, Shield, Info, ArrowUp, Facebook, Twitter, Instagram, Linkedin, ArrowDown } from 'lucide-react';

// Moved AnimatedDestinations component outside of UserLayout
...
<div className="relative h-screen flex items-center justify-center overflow-hidden">
  ...
  <div className="text-center px-4 z-10">
    ...
    <div className="flex flex-col items-center">
      <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 flex items-baseline justify-center">
        <span className="whitespace-nowrap mr-2">Travel to</span>
    ...
    >
      ...
      <div id="history" className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 mb-8 flex items-center">
            ...
            <span className="px-4 text-gray-500 font-medium">Key Milestones</span>
            <div className="flex-1 border-t border-gray-200"></div>
          </div>
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-1/2 h-full w-0.5 bg-gradient-to-b from-purple-200 to-blue-200 transform -translate-x-1/2"></div>
            
            <div className="space-y-8">
              {/* Timeline Item 1 */}
              <div className="relative flex items-center">
                <div className="hidden md:block absolute left-1/2 w-6 h-6 bg-purple-600 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
                <div className="w-full md:w-1/2 md:pr-8">
                  <div className="p-4 bg-purple-50 rounded-lg shadow-sm border border-purple-100">
                    <div className="flex items-center mb-2">
                      <div className="w-4 h-4 bg-purple-600 rounded-full mr-2"></div>
                      <span className="font-bold text-purple-700">1920</span>
                    </div>
                    <p className="text-gray-700">First private bus services introduced in Colombo by Ceylon Motor Transit Co.</p>
                  </div>
                </div>
                ...
                <div className="w-full md:w-1/2 md:pl-8">
                  <div className="p-4 bg-blue-50 rounded-lg shadow-sm border border-blue-100">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="font-bold text-blue-700">1864</span>
                    </div>
                    <p className="text-gray-700">Colombo-Ambepussa railway opens, marking birth of Sri Lanka Railways</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative flex items-center">
                ...
                <div className="w-full md:w-1/2 md:pr-8">
                  <div className="p-4 bg-purple-50 rounded-lg shadow-sm border border-purple-100">
                    <div className="flex items-center mb-2">
                      <div className="w-4 h-4 bg-purple-600 rounded-full mr-2"></div>
                      <span className="font-bold text-purple-700">1958</span>
                    </div>
                    <p className="text-gray-700">Ceylon Transport Board established, nationalizing bus transport</p>
                  </div>
                </div>
                <div className="hidden md:block w-1/2"></div>
              </div>
      ...
      <div id="terms" className="py-16 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Terms and Conditions</h2>
          
          <div className="prose max-w-none">
            <h3 className="text-xl font-semibold mb-3">Booking Policy</h3>
            <ul className="list-disc pl-5 mb-6 space-y-2 text-gray-700">
              <li>Tickets are non-transferable and valid only for the date and time specified</li>
              <li>Booking modifications are allowed up to 24 hours before departure</li>
              <li>Cancellations made 48+ hours before departure receive full refund</li>
              <li>Late cancellations incur a 25% processing fee</li>
            </ul>
            
            <h3 className="text-xl font-semibold mb-3">Travel Requirements</h3>
            <ul className="list-disc pl-5 mb-6 space-y-2 text-gray-700">
              <li>Passengers must arrive at least 30 minutes before departure</li>
              <li>Valid ID required for ticket collection</li>
              <li>Children under 5 travel free but must not occupy seats</li>
              <li>Luggage limit: 20kg per passenger</li>
            </ul>
            
            <h3 className="text-xl font-semibold mb-3">General Terms</h3>
            <p className="text-gray-700 mb-4">
              The company reserves the right to alter schedules, routes, or fares when necessary. 
              We are not liable for delays caused by weather, traffic, or unforeseen circumstances.
            </p>
            <p className="text-gray-700">
              By using our services, you agree to comply with all government regulations and transportation laws.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="bg-gradient-to-b from-purple-600 to-blue-600 p-8 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-8 pt-6 border-t border-white/20">
                    ...
                    <div className="flex items-center">
                      <Clock className="mr-3 text-white/80" size={18} />
                      <span className="text-white/90">Monday - Sunday: 6:00 AM - 10:00 PM</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="relative">
                      <input
                        ...
                        className="w-full p-4 bg-white border border-gray-200 rounded-xl focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all peer"
                        placeholder=" "
                        required
                      />
                      <label className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none transition-all peer-placeholder-shown:text-base peer-placeholder-shown:top-1/2 peer-focus:top-0 peer-focus:text-sm peer-focus:text-purple-600 peer-focus:bg-white peer-focus:px-2 peer-focus:left-3 bg-white">
                        Your Name
                      </label>
                    </div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      required
                    ></textarea>
                    <label className="absolute left-4 top-4 text-gray-400 pointer-events-none transition-all peer-placeholder-shown:text-base peer-focus:top-0 peer-focus:text-sm peer-focus:text-purple-600 peer-focus:bg-white peer-focus:px-2 peer-focus:left-3 bg-white">
                      Your Message
                    </label>
                  </div>
